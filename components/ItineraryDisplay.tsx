                  ...
                  <div className="flex gap-4 flex-col md:flex-row">
                    ...
                    <div className="flex-shrink-0 w-full md:w-48 h-48 rounded-lg overflow-hidden relative">
                      ...
                      <div 
                        ...
                        onClick={() => window.open(`https://www.google.com/maps?q=${activity.coordinates.latitude},${activity.coordinates.longitude}`, '_blank')}
                      />
                    </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div 
                        ...
                        onClick={() => copyToClipboard(`${activity.coordinates.latitude}, ${activity.coordinates.longitude}`)}
                      >
